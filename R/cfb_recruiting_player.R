...
#'
#' If you would like CFB recruiting information for teams, please see the \code{\link[cfbrecruitR:cfb_recruiting_team]{cfbrecruitR::cfb_recruiting_team()}}  function
#'
#' If you would like to get CFB recruiting information based on position groups during a
#' time period for all FBS teams, please see the \code{\link[cfbrecruitR:cfb_recruiting_position]{cfbrecruitR::cfb_recruiting_position()}} function.
#'
