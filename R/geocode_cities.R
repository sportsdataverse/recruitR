...
#' geocode_cities(2018)
#'
#' geocode_cities(2018,team="Texas")
#'
#' geocode_cities(2016,recruit_type = 'JUCO')
#' geocode_cities(2020, recruit_type = 'HighSchool', position ='OT', state = 'FL')
#'


geocode_cities <- function(year, team = NULL, recruit_type = NULL,
