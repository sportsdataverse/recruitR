...
#' see the \code{\link[cfbrecruitR:cfb_recruiting_player]{cfbrecruitR::cfb_recruiting_player()}} function
#'  
#' If you would like CFB recruiting information for teams, please 
#' see the \code{\link[cfbrecruitR:cfb_recruiting_team]{cfbrecruitR::cfb_recruiting_team()}} function
#' 
...
cfb_recruiting_position <- function(start_year = NULL, end_year = NULL,
  ...
  if(!is.null(conference)){
    ...
    assert_that(conference %in% cfbrecruitR::cfb_conf_types_df$name,
