...
```
    ...
    ## ℹ Data updated: 2026-06-09 23:44:22 UTC
...
```
    ...
    ## ℹ Summaries were computed grouped by state_province and stars.
    ## ℹ Output is grouped by state_province.
    ## ℹ Use `summarise(.groups = "drop_last")` to silence this message.
    ## ℹ Use `summarise(.by = c(state_province, stars))` for per-operation grouping
